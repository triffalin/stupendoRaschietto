...
DEV_MODE = os.getenv('STUPENDORASCHIETTO_TEST') == '1'
DEV_MODE_ALL = os.getenv('STUPENDORASCHIETTO_TEST_ALL') == '1'
DEV_MODE_TOTAL = os.getenv('STUPENDORASCHIETTO_TEST_TOTAL') == '1'
CACHE_LOG = os.getenv('STUPENDORASCHIETTO_CACHE_LOG') == '1'
AWS_ADMIN = os.getenv('STUPENDORASCHIETTO_AWS_ADMIN') == '1'
ACCESS_KEY = os.getenv('STUPENDORASCHIETTO_ACCESS_KEY')
SECRET_ACCESS_KEY = os.getenv('STUPENDORASCHIETTO_SECRET_ACCESS_KEY')
...
def __encode(clear, key='stupendoRaschietto'):
    enc = []
...
def __decode(enc, key='stupendoRaschietto'):
    dec = []
